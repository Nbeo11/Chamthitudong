...
import { createQuestion_bank, getQuestion_bankdetails } from '../../../api/question_bank';
import '../../../assets/css/table.css';

const Question_bank_update = () => {
    ...
    const { question_bankId } = useParams();
    const [question_bankInfo, setQuestion_bankInfo] = useState({
        moduleId: '',
        question_format: '',
        difficulty: '',
        question_detail: '',
    ...
    useEffect(() => {
        const fetchQuestion_bankInfo = async () => {
            try {
                const response = await getQuestion_bankdetails(question_bankId);
                setQuestion_bankInfo(response);
                console.log('question_bankInfo: ', question_bankInfo)
                console.log(response)
                console.log(question_bankId)
            } catch (error) {
                console.error('Error fetching question_bank info:', error);
            }
        };

        fetchQuestion_bankInfo();
    }, [question_bankId]);
                                    ...
                                    <Form.Group as={Row} className="mb-3" controlId="moduleId">
                                        ...
                                        <Col md={8} sm={8} className="d-flex align-items-center">
                                            <Form.Select
                                                ...
                                                value = {question_bankInfo.moduleId}
...
export default Question_bank_update;
